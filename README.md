...
A secure zone that you control. PrivacySafe is built from Free/Libre and Open Source Software (FLOSS) with an architecture designed around user-held keys and verifiable software:
...
PrivacySafe is modular and portable. Portable builds can run from removable media, and we publish 100% of our client and server source code on [Github](https://codeberg.org/PrivacySafe) and [Codeberg](https://codeberg.org/PrivacySafe).
...
* **Core 3NWeb Client Library:** Core processes, cryptographic and protocol state, local caches, and APIs. [Source](https://github.com/PrivacySafe/core-3nweb-client-lib)
* **WASM Message Passing for 3NWeb:** Message-passing support between WebAssembly and 3NWeb platform. [Source](https://github.com/PrivacySafe/wasm-message-passing-3nweb)
* **XSP Files:** Implementation of the XSP encrypted-file format used by 3NStorage. [Source](https://github.com/PrivacySafe/xsp-files)
...
The Foundation website provides options for card donations, PayPal/Venmo, cryptocurrency, checks, and other forms of support. Donations are often tax-deductible in the USA. Federal EIN: 41-5237617.
